// contains quotes to update rwIndex
const myQuotes=
[
    {
    ...
    { quote: 'They call me Mister Tibbs!', movie: 'In the Heat of the Night' },
    { quote: 'Rosebud.', movie: 'Citizen Kane' },
    ...
    { quote: "Play it, Sam. Play 'As Time Goes By.'", movie: 'Casablanca' },
    ...
    { quote: 'We rob banks.', movie: 'Bonnie and Clyde' },
    ...
    { quote: 'Shane. Shane. Come back!', movie: 'Shane' },
    { quote: "Well, nobody's perfect.", movie: 'Some Like It Hot' },
    ...
    { quote: 'La-dee-da, la-dee-da.', movie: 'Annie Hall' },
    { quote: "A boy's best friend is his mother.", movie: 'Psycho' },
    ...
    { quote: 'What a dump.', movie: 'Beyond the Forest' },
    {
    ...
    { quote: 'No wire hangers, ever!', movie: 'Mommie Dearest' },
    {
    ...
    { quote: 'Open the pod bay doors, HAL.', movie: '2001: A Space Odyssey' },
    {
      ...
      movie: 'Rumack: "I am serious … and don\'t call me Shirley.',
      movie: 'Airplane!',
    },
    { quote: 'Yo, Adrian!', movie: 'Rocky' },
    { quote: 'Hello, gorgeous.', movie: 'Funny Girl' },
    { quote: 'Toga! Toga!', movie: "National Lampoon's Animal House" },
    {
    ...
    { quote: 'A martini. Shaken, not stirred.', movie: 'Goldfinger' },
    { quote: "Who's on first?", movie: 'The Naughty Nineties' },
    {
      quote:
    ...
    { quote: 'Snap out of it!', movie: 'Moonstruck' },
    {
      quote:
...
//   functionality to update the random quote section
// for rwIndex.html

function getRandomQuote(){
    // find the length of the array
    // generate a random number within that length
    // use that to send back a quote object
    let length=myQuotes.length;
    let randomIndex=Math.floor(Math.random()*length);
    // console.log("index is ",randomIndex);
    return myQuotes[randomIndex];
}
const updateRandomQuote=function(){
    let randomQuote=getRandomQuote();
    // now update the DOM
    document.querySelector('#random-quote-text').innerHTML='"'+ randomQuote.quote+'"';
    document.getElementById("random-quote-movie").innerHTML=`From: ${randomQuote.movie}`;
}
// add an event listener to the new-quote button to bind the click event
document.querySelector('#new-quote').addEventListener("click",updateRandomQuote);